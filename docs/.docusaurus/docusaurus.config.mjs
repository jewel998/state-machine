...
export default {
  ...
  "tagline": "A lightweight, type-safe state machine library for JavaScript/TypeScript",
  "favicon": "img/favicon.ico",
  "url": "https://jewel998.github.io",
  "baseUrl": "/state-machine/",
  "organizationName": "jewel998",
  ...
  "themeConfig": {
    ...
    "footer": {
      ...
      "copyright": "Copyright © 2025 jewel998. Built with Docusaurus."
    },
    "prism": {
      "theme": {
        "plain": {
